...
public class GameOverLayer extends CCLayer{
	...
	public GameOverLayer(){
		...
		CCSprite background = CCSprite.sprite("game_over.jpg");
		...
		CCSprite lose = CCSprite.sprite("Game-Over.png");
		lose.setPosition(CGPoint.ccp(screenSize.width / 2, 3*screenSize.height/ 4));
